...
import yanzhengma
from followdream.models import IP,Dream
...
def createdream(request):
    ...
    code_img[0].save("./followdream/static/css/validate.png", "PNG")
...
def getVCode(request):
    ...
    code_img = yanzhengma.create_validate_code()
    code_img[0].save("./followdream/static/css/validate.png", "PNG")
    image_data = open("./followdream/static/css/validate.png","rb").read()
